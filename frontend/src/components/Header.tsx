      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-bold text-white">Complaint Portal</h1>
          </div>
          <button 
            onClick={onCreateComplaint} 
            className="bg-white text-purple-700 hover:bg-purple-50 px-4 py-2 rounded-lg font-medium flex items-center gap-2 shadow-md transition-all hover:shadow-lg text-sm"
          >
